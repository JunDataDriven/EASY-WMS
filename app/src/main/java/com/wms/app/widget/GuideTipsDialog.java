...
import com.wms.app.core.http.api.ApiService;
import com.wms.app.core.http.callback.NoTipCallBack;
import com.wms.app.core.http.entity.TipInfo;
import com.wms.app.utils.MMKVUtils;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private static final String KEY_IS_IGNORE_TIPS = "com.wms.app.widget.key_is_ignore_tips_";
